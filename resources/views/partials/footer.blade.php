            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#skills-section"><span class="fa fa-chevron-right mr-2"></span>Skill</a></li>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map marker"></span><span class="text"> 186 M 8 Pak Prak,Don Sak, Surat Thani 84340</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">080-690-6003</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">apidetkeodpakprak@gmail.com</span></a></li>
                        </ul>
                    </div>
